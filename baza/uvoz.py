...
def ustvari_bazo_in_uvozi_podatke(pot_do_baze):
    ...
    povezava_na_bazo = sqlite3.connect(pot_do_baze)       # ustvari povezavo na SQLite bazo (če ne obstaja, se ustvari nova)
